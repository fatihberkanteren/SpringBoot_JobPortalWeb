package com.fatihberkant.jobportal.config;

import com.fatihberkant.jobportal.services.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(form -> form.loginPage("/login").permitAll().successHandler(customAuthenticationSuccesHandler)).logout(logout->{
