...
import com.fatihberkant.jobportal.entity.*;
import com.fatihberkant.jobportal.services.JobPostActivityService;
import com.fatihberkant.jobportal.services.JobSeekerApplyService;
import com.fatihberkant.jobportal.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        if (!dateSearchedFlag && !remote && !type && !StringUtils.hasText(job) && !StringUtils.hasText(location)) {
